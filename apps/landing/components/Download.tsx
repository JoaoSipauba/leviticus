...
type Props = { release: ReleaseInfo }
      ...
      <div className="container">
        ...
        <div className="downloads-grid">
          ...
          <div className="download-card">
            ...
            <div className="download-meta">v{release.version} · ~{release.macSizeMB} MB · .dmg</div>
          ...
          <div className="download-card">
            ...
            <div className="download-meta">v{release.version} · ~{release.winSizeMB} MB · .exe</div>
