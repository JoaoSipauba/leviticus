...
import { APP_VERSION, DOWNLOAD_MAC, DOWNLOAD_WIN } from '@/lib/config'
      ...
      <div className="container">
        ...
        <div className="downloads-grid">
          ...
          <div className="download-card">
            ...
            <div className="download-meta">v{APP_VERSION} · ~9 MB · .dmg</div>
            <a href={DOWNLOAD_MAC} className="btn btn-primary download-btn">
          ...
          <div className="download-card">
            ...
            <div className="download-meta">v{APP_VERSION} · ~6 MB · .exe</div>
            <a href={DOWNLOAD_WIN} className="btn btn-primary download-btn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v14M5 12l7 7 7-7"/></svg>
              Baixar para Windows
            </a>
          </div>
